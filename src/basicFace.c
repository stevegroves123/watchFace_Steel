...
static void main_window_load(Window *window)
  ...
  s_message_layer = text_layer_create(GRect (0, 120, 144, 50));
  text_layer_set_background_color(s_message_layer, GColorBlack);
  text_layer_set_text_color(s_message_layer, GColorWhite);  
  text_layer_set_text(s_message_layer, "time");
  text_layer_set_font(s_message_layer, fonts_get_system_font(FONT_KEY_BITHAM_42_BOLD));
